...
class PopularityRQVAETokenizerOptimizer(RQVAETokenizerOptimizer):
    """RQ-VAE optimizer with popularity and prefix debias objectives.

    This class owns all popularity-specific state: transformed item weights,
    candidate assignment, EMA token mass, prefix beam observations, and
    diagnostics.  The baseline optimizer has no dependency on this module.
    """

    is_debias_optimizer = True
    ...
    def _config_get(self, key: str, legacy_key: str | None = None, default=None):
        """Read the new debias key while accepting the original aliases."""
